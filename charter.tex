...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un conjunto de métodos que permitirán detectar cambios significativos en las transmisiones de video de cámaras IP. El trabajo tendrá un presupuesto preliminar estimado de 665 horas y un costo estimado de \textcolor{red}{\$ XXX}, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
